...
//pour stocker les inspecteurs
	...
	public void finduJeu() { 																					//Voil‡ la fonction qui cÈlËbre le vainqueur en fonction du rÈsulat de l'ultime test
		System.out.println("GAME OVER");
		if (this.tours==8) {
			this.joueurActu.setText("BRAVO aux inspecteurs qui GAGNENT cette partie");
		}else {
			this.joueurActu.setText("BRAVO √† Mr Jack qui GAGNE cette partie");
		};
	}
	...
	public void utiliserJetons(){
		if (this.joueur1.getTemps()>=8) {finduJeu();}															//on vÈrifie que Mr.Jack n'est pas gagner aprËs chaque jetons
