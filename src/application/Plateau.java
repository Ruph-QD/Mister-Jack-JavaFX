...
public class Plateau {
	...
	// Constructeurs
	public Plateau() {
		// Creation des elements de la classe plateau qui permettra d'afficher sur le
		// plateau les elements suivants :
		this.plateau = new ArrayList<Tuiles>();
		this.plateau.add(new Tuiles("TLestrade", "TLestrade90", "TLestrade180", "TLestrade270", "Verso", "Verso90",
				"Verso180", "Verso270"));
		this.plateau.add(
				new Tuiles("TBert", "TBert90", "TBert180", "TBert270", "Verso", "Verso90", "Verso180", "Verso270"));
		this.plateau.add(new Tuiles("TGoodley", "TGoodley90", "TGoodley180", "TGoodley270", "Verso", "Verso90",
				"Verso180", "Verso270"));
		this.plateau.add(
				new Tuiles("TGull", "TGull90", "TGull180", "TGull270", "Verso", "Verso90", "Verso180", "Verso270"));
		this.plateau.add(new Tuiles("TLane", "TLane90", "TLane180", "TLane270", "Middle_verso", "Middle_verso",
				"Middle_verso", "Middle_verso"));
		this.plateau.add(new Tuiles("TMadame", "TMadame90", "TMadame180", "TMadame270", "Verso", "Verso90", "Verso180",
				"Verso270"));
		this.plateau.add(
				new Tuiles("TPizer", "TPizer90", "TPizer180", "TPizer270", "Verso", "Verso90", "Verso180", "Verso270"));
		this.plateau.add(
				new Tuiles("TSmith", "TSmith90", "TSmith180", "TSmith270", "Verso", "Verso90", "Verso180", "Verso270"));
		this.plateau.add(new Tuiles("TStealthy", "TStealthy90", "TStealthy180", "TStealthy270", "Verso", "Verso90",
				"Verso180", "Verso270"));

		ArrayList<String> positionnement = new ArrayList<String>(); // tableau qui contient les positions (ne sert que
																	// pour l'initialisation du tableau)
		for (int k = 1; k < 9; k++) {
			positionnement.add(Integer.toString(k));
		}
		...
		for (int k = 0; k < 9; k++) {
			...
			this.plateau.get(k).setImageAffichee(this.plateau.get(k).getImage(this.plateau.get(k).getAngle())); // definis
																												// l'image
																												// qui
																												// doit
																												// etre
		...
		Comparator<Tuiles> compareByPosition = (Tuiles tuile1, Tuiles tuile2) -> Integer.toString(tuile1.getPosition())
				.compareTo(Integer.toString(tuile2.getPosition()));
